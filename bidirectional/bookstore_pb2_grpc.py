...
class BookStoreStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.liveCartValue = channel.stream_stream(
                '/BookStore/liveCartValue',
...
def add_BookStoreServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'liveCartValue': grpc.stream_stream_rpc_method_handler(
                    servicer.liveCartValue,
...
class BookStore(object):
    ...
    @staticmethod
    def liveCartValue(request_iterator,
            target,
            options=(),
